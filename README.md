...
The full transcript is editable and downloadable. Both YouTube and uploaded-audio transcripts normalize the known spelling Xperis to Experis, including timestamped segments, before summaries or exports use the text. Choose **Article URL** in the top **Start with** selector to summarize an article directly. Paste its link, choose the summary settings and select **Create summary**. YouTube and audio inputs offer the same summary settings after transcription. Choose **Standard** (default), **Plain language**, or **Technical depth**, and **1, 3, 5 or 8 paragraphs**. Article imports support 150 to 24,000 characters; transcript summaries support up to 200,000 characters. Long transcripts are summarized in sections before a final summary is written. Summaries use a source-grounded prompt with direct wording and no em dashes. Review the result before sharing; the model can still make mistakes.
